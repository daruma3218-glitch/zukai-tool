...
- **allowed_terms を省略・空配列にしない**: excerpt 内に固有名詞・数値・年代が1つでも
  あれば必ず列挙する（本当に無い場合のみ空）。件数が多く出力が長くなる場合も
  allowed_terms は削らず、excerpt を短くする方を選ぶこと
...
[
  {{
    "index": 1,
    "excerpt": "原稿からの正確な抜粋（1〜2文・全角120字以内を目安、原文ママ）",
